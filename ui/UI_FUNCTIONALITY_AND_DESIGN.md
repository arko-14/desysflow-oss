...
Core files:
- `ui/src/App.jsx`: shell, state, data flow, layout composition.
- `ui/src/App.css`: global styling, layout and responsive behavior.
- `ui/src/components/MermaidDiagram.jsx`: Mermaid rendering and diagram interactions.
- `ui/src/components/LoadingState.jsx`: async progress and operation feedback.
- `ui/src/components/*`: artifact-specific views.
